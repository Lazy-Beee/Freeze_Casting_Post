...
# print('\n-----Y Plane search test-----')
# ifs.FRAME_TIME = 300
# ifs.FILE_NAME = ['center-0300', 'node-0300']
...
# ax.plot(temp_x, temp_z, color=color2, label='Temperature')
# ax.plot(lf_x, lf_z, color=color1, label='Liquid Fraction')
# ax.legend(loc="upper left")
#
# plt.title('90deg/323.15K hot-finger, y = 0 mm, t = 300s')
# fig.tight_layout()
#
# plt.savefig('images/y0_if_temp_lf.png')
# plt.close()
#
